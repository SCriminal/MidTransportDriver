...
//透明度
#define COLOR_BLACK_ALPHA_PER30 [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:0.3]
...
#define LOCAL_TRANSPORT_LOADING @"LOCAL_TRANSPORT_LOADING"
#define LOCAL_PLATE_NUMBER @"LOCAL_PLATE_NUMBER"
...
#define NOTICE_TRANSPORTORDER_REFERSH @"NOTICE_TRANSPORTORDER_REFERSH"//运单msg
#define NOTICE_AUTH_REFERSH @"NOTICE_AUTH_REFERSH"//认证msg
#define NOTICE_POCKET_REFERSH @"NOTICE_POCKET_REFERSH"//钱包msg
#define NOTICE_AUTOORDER_REFERSH @"NOTICE_AUTOORDER_REFERSH"//计划单msg

#define NOTICE_MSG_REFERSH @"NOTICE_MSG_REFERSH"//消息修改
#define NOTICE_EXTENDTOKEN @"NOTICE_EXTENDTOKEN"
