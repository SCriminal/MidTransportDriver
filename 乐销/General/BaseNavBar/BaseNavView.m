...
- (UILabel *)labelTitle{
    if (!_labelTitle) {
        ...
        [GlobalMethod setLabel:_labelTitle widthLimit:SCREEN_WIDTH - W(50) * 2 numLines:1 fontNum:F(16) textColor:[UIColor blackColor] text:@""];
    }
    return _labelTitle;
}
- (UIView *)line{
